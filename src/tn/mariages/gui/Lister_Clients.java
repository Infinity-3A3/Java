 ...
 * @author khaled
 */
public class Lister_Clients extends javax.swing.JFrame {

    /**
     * Creates new form Lister_Clients
     */
    public Lister_Clients() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lister_Clients.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lister_Clients().setVisible(true);
            }
        });
    }
